...
import {
  Trophy, Crown, Star, Flame, Droplets,
  Mountain, Wind, TreePine, CloudLightning, Skull,
} from "lucide-react";
  ...
  return (
    <div className="relative min-h-screen text-white overflow-x-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center pt-16 pb-8 px-5 text-center">
        ...
        >
          Guild Wars Season I is over. The forge has cooled. Those who made it through are immortalised below.
        </motion.p>
      </div>
        ...
        >
          ...
          <div className="relative z-10">
            ...
            <div
              ...
              style={{ color: "#22c55e", textShadow: "0 0 60px rgba(34,197,94,0.5)", fontFamily: "Georgia, serif" }}
            >
      ...
      >
        <div className="flex items-center gap-2 mb-5">
          ...
          <span className="text-[10px] text-white/25 font-mono">Season I Final</span>
        </div>
      ...
      >
        ...
        >
          <div className="inline-flex flex-col items-center gap-3">
            ...
            <p className="text-[11px] text-white/25 font-mono uppercase tracking-[0.3em]">
