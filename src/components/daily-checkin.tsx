...
const BASE =
  "https://gmyplyxwxmkvptimzgid.supabase.co/storage/v1/object/public/Assets/Game%20assets";

// ── Reward definitions ────────────────────────────────────────────────────────
// Day 7 fixed: Item Box + 1000 Points (no mystery box)
const REWARDS: {
  day: number;
  label: string;
  subLabel: string;
  ...
  },
  {
    ...
    label:    "Item Box",
    subLabel: "Day 6",
    img:      `${BASE}/itembox-closed.png`,
    color:    "text-purple-400",
    glow:     "rgba(168,85,247,0.3)",
  },
  {
    day: 7,
    label:    "Item Box + 1000 Points",   // ← FIXED: was "Mystery Box + 1000 Coins"
    subLabel: "Day 7",
    img:      `${BASE}/itembox-closed.png`, // ← FIXED: item box image, not mystery box
...
export function DailyCheckIn({
  ...
  const dayIndex    = (nextDay - 1) % 7;       // 0-based
        ...
        >
          ...
          <AnimatePresence>
            {claimed && claimedReward && (
              <ClaimedOverlay
                ...
                onClose={() => { setClaimed(false); onClose(); }}
              />
            )}
          </AnimatePresence>
          ...
          <div className="p-5">
            ...
            {isLoading ? (
              ...
              <div
                className="rounded-2xl border border-white/10 bg-white/5 p-5 text-center mb-4"
